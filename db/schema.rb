...
ActiveRecord::Schema[7.1].define(version: 2024_04_10_134049) do
  create_table "active_sessions", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
